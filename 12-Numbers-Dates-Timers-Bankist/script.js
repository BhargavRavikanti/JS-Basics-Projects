...
// Base 10 - 0 to 10 1/10 = 0.1, 3/10 = 3.333333
// Binary base 2 - 0,1
console.log(0.1 + 0.2);
...
console.log(Number.isFinite(23 / 10));
...
console.log(234223554353463466546546565654665465465n);
console.log(BigInt(234223554353463466546546565654665465465));
console.log(BigInt(334534563));
